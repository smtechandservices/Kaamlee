    ...
    <div className="flex justify-center gap-2">
      {digits.map((digit, i) => (
        <input
          ...
          className="w-11 h-12 sm:w-12 sm:h-14 bg-white border border-black/[0.10] rounded-2xl text-center text-lg font-semibold text-[#0b0b0c] focus:border-purple-600 focus:shadow-[0_0_0_4px_rgba(124,58,237,.12)] outline-none transition-all"
        />
      ))}
    </div>
  );
