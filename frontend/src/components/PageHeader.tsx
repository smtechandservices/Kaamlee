...
interface PageHeaderProps {
  ...
  /** Extra content on the right, rendered before the mobile Back link (e.g. view-mode toggles). */
  ...
  return (
    <header className="h-16 border-b border-black/[0.08] bg-white/80 backdrop-blur-md px-4 sm:px-6 flex items-center justify-between z-20 shrink-0" style={{ fontFamily: 'var(--font-outfit)' }}>
      ...
      <div className="flex items-center gap-2">
        {children}
        <Link href={backHref} title="Back" className="group flex md:hidden items-center gap-1.5 sm:gap-2 text-black/45 hover:text-[#0b0b0c] transition-colors shrink-0">
