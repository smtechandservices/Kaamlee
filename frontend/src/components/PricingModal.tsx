...
import { ArrowRight, RotateCcw, ArrowLeft, Check, Clock } from 'lucide-react';
            ...
            <div className="text-white relative z-10 flex flex-col items-center text-center">
              ...
              >
                ...
                <div className="relative group/btn w-full">
                  ...
                  <button
                    onClick={handleCTA}
                    className="relative w-full flex items-center justify-center gap-3 sm:gap-4 bg-white text-black px-6 sm:px-8 py-3.5 sm:py-4 rounded-sm font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-xs sm:text-sm hover:bg-[#ededed] transition-all overflow-hidden cursor-pointer"
                  >
                    <span>{!user ? 'Log in to Access' : 'Explore Jobs'}</span>
